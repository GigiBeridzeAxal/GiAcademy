...
<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">ეს პროგრამული ენაა Frontend Framework-ის ყველაზე ძლიერი იარაღი რაშიც გაერთიანებულია HTML,CSS,Javascript, და კიდევ ბევრი ენა </p>
